...
function Dish({ label, imageUrl }: DishProps) {
  return (
    <div className="group">
      <div className="relative aspect-1 w-16 overflow-hidden rounded-lg bg-gray-700 md:w-24 lg:w-28">
    ...
    <div className="flex w-full flex-col gap-8">
      ...
      <div className="flex min-w-full gap-4 overflow-x-auto rounded-md bg-slate-700 p-2 shadow-xl">
        {resultHistory.length === 0 && (
          <div className="grid aspect-1 h-16 w-full place-items-center text-gray-400 md:h-24 lg:h-28">
            {t("No history yet")}
          </div>
        )}
